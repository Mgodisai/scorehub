...
3. **Branch naming convention:** <type>/<issue-number>-short-description
   - eature/4-sheetmusic-entity
   - ix/12-pagination-bug
   - docs/update-api-examples
   - efactor/15-extract-base-entity
   - 	est/9-integration-tests
...
| Type | When to use |
|------|-------------|
| eat | New feature or functionality |
| ix | Bug fix |
...
ci: add GitHub Actions workflow with PostgreSQL service (#8)
...
- Reference issues in commits: eat: add entity (#4)
...
#8 CI pipeline (can start after #1)
...
4. **Run tests before pushing** — ./gradlew test
